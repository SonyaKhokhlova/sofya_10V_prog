...
namespace txtschedule
{
    internal class Program
    {
        ...
        public class DayOfWeek
        {
            ...
            public List<string> ChangeLesson(string numl, string namel, string classl, string path, int numofline)
            {
                try
                {
                    ...
                    if (a - 1 >= 0 && a - 1 <= 7)
                    {
                        ...
                        string lineadd1 = String.Format(format: "{0, -15} {1, -15} {2, -20}",
                        arg0: lineadd,
                        arg1: namel,
                        arg2: classl);
                        array[numofline] = lineadd1;
                        return array;
                    }
                    else
                    {
            ...
            public List<string> RemoveLesson(string numl, string path, int numofline)
            {
                try
                {
                    int a = Convert.ToInt32(numl);
            ...
            while (true)
            {
                ...
                if (command == "!ИзменитьУрок")
                {
                    ...
                    try
                    {
                        if (addday == "Понедельник" || addday == "понедельник")
                        {
                            ...
                            List<string> today1 = today.ChangeLesson(addnum, addname, addclass, filepath, Convert.ToInt32(addnum) + 1);
                            if (today1 != null)
                            {
                                fileInfo.Delete();
                                using (StreamWriter sw = new StreamWriter(filepath, true, System.Text.Encoding.UTF8))
                                {
                                    for (int i = 0; i < today1.Count; i++)
                                    {
                                        sw.WriteLine(today1[i]);
                                    }
                                }
                            }
                        }
                        else if (addday == "Вторник" || addday == "вторник")
                        {
                            ...
                            List<string> today1 = today.ChangeLesson(addnum, addname, addclass, filepath, Convert.ToInt32(addnum) + 12);
                            if (today1 != null)
                            {
                                fileInfo.Delete();
                                using (StreamWriter sw = new StreamWriter(filepath, true, System.Text.Encoding.UTF8))
                        ...
                        else if (addday == "Среда" || addday == "среда")
                        {
                            ...
                            List<string> today1 = today.ChangeLesson(addnum, addname, addclass, filepath, Convert.ToInt32(addnum) + 23);
                            if (today1 != null)
                            {
                                fileInfo.Delete();
                                using (StreamWriter sw = new StreamWriter(filepath, true, System.Text.Encoding.UTF8))
                        ...
                        else if (addday == "Четверг" || addday == "четверг")
                        {
                            ...
                            List<string> today1 = today.ChangeLesson(addnum, addname, addclass, filepath, Convert.ToInt32(addnum) + 34);
                            if (today1 != null)
                            {
                                fileInfo.Delete();
                                using (StreamWriter sw = new StreamWriter(filepath, true, System.Text.Encoding.UTF8))
                        ...
                        else if (addday == "Пятница" || addday == "пятница")
                        {
                            ...
                            List<string> today1 = today.ChangeLesson(addnum, addname, addclass, filepath, Convert.ToInt32(addnum) + 45);
                            if (today1 != null)
                            {
                                fileInfo.Delete();
                                using (StreamWriter sw = new StreamWriter(filepath, true, System.Text.Encoding.UTF8))
                        ...
                        else if (addday == "Суббота" || addday == "суббота")
                        {
                            ...
                            List<string> today1 = today.ChangeLesson(addnum, addname, addclass, filepath, Convert.ToInt32(addnum) + 56);
                            if (today1 != null)
                            {
                                fileInfo.Delete();
                                using (StreamWriter sw = new StreamWriter(filepath, true, System.Text.Encoding.UTF8))
                ...
                else if (command == "!УдалитьУрок")
                {
                    ...
                    try
                    {
                        ...
                        {
                            DayOfWeek today = tt.Days[0];
                            List<string> today1 = today.RemoveLesson(removenum, filepath, Convert.ToInt32(removenum) + 1);
                            if (today1 != null)
                            {
                                fileInfo.Delete();
                                using (StreamWriter sw = new StreamWriter(filepath, true, System.Text.Encoding.UTF8))
                        ...
                        {
                            DayOfWeek today = tt.Days[1];
                            List<string> today1 = today.RemoveLesson(removenum, filepath, Convert.ToInt32(removenum) + 12);
                            if (today1 != null)
                            {
                                fileInfo.Delete();
                                using (StreamWriter sw = new StreamWriter(filepath, true, System.Text.Encoding.UTF8))
                        ...
                        {
                            DayOfWeek today = tt.Days[2];
                            List<string> today1 = today.RemoveLesson(removenum, filepath, Convert.ToInt32(removenum) + 23);
                            if (today1 != null)
                            {
                                fileInfo.Delete();
                                using (StreamWriter sw = new StreamWriter(filepath, true, System.Text.Encoding.UTF8))
                        ...
                        {
                            DayOfWeek today = tt.Days[3];
                            List<string> today1 = today.RemoveLesson(removenum, filepath, Convert.ToInt32(removenum) + 34);
                            if (today1 != null)
                            {
                                fileInfo.Delete();
                                using (StreamWriter sw = new StreamWriter(filepath, true, System.Text.Encoding.UTF8))
                        ...
                        {
                            DayOfWeek today = tt.Days[4];
                            List<string> today1 = today.RemoveLesson(removenum, filepath, Convert.ToInt32(removenum) + 45);
                            if (today1 != null)
                            {
                                fileInfo.Delete();
                                using (StreamWriter sw = new StreamWriter(filepath, true, System.Text.Encoding.UTF8))
                        ...
                        {
                            DayOfWeek today = tt.Days[5];
                            List<string> today1 = today.RemoveLesson(removenum, filepath, Convert.ToInt32(removenum) + 56);
                            if (today1 != null)
                            {
                                fileInfo.Delete();
                                using (StreamWriter sw = new StreamWriter(filepath, true, System.Text.Encoding.UTF8))
